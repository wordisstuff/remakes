...
import { formValuesSignup, signupSchema } from './Shema.js';
...
import UsersWrap from '../UsersWrap/UsersWrap.jsx';
                ...
                >
                    ...
                    <div className={style.fieldThumb}>
                        ...
                        <div className={style.passwordWrapper}>
                            <input
                                className={`${style.formInput} ${
                                    errors.password && style.errorName
                                }`}
                    ...
                    <div className={style.fieldThumb}>
                        ...
                        <div className={style.passwordWrapper}>
                            <input
                                className={`${style.formInput} ${
                                    style.formPhone
                                } ${errors.repeatPassword && style.errorName}`}
